...
app.use("/recipes", require('./routes/recipe/details'))
app.use("/recipes", require('./routes/recipe/delete'))
app.use("/", require('./routes/recipe/create'))
app.use("/", require('./routes/recipe/review'))
app.use("/", require('./routes/recipe/update'))
app.use("/", require('./routes/chef/createChef'))
app.use("/", require('./routes/chef/chefList'))
